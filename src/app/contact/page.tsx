...
export default function ContactPage() {
    return (
        <SectionContainer id="contact-section" animated bgColorClass="bg-section-contact" fullWidthBg>
            ...
            <p className="text-center text-lg text-muted-foreground mb-12 max-w-2xl mx-auto font-sans">
                I'm always excited to discuss new projects, creative ideas, or opportunities to collaborate. Feel free
                to reach out using the form below or through my social channels.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
                <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg shadow-md">
                    ...
                    <p className="text-muted-foreground font-sans">New Delhi, India (Open to remote)</p>
                </div>
                <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg shadow-md">
                    <Mailbox className="h-10 w-10 text-primary mb-3" />
                    <h3 className="text-xl font-headline text-foreground mb-1">Email</h3>
                    <a
                        href="mailto:hello@priyanshuranjan.dev"
                        className="text-muted-foreground hover:text-primary font-sans break-all"
                    >
                        hello@priyanshuranjan.dev
                    </a>
                </div>
                <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg shadow-md">
                    <Phone className="h-10 w-10 text-primary mb-3" />
                    <h3 className="text-xl font-headline text-foreground mb-1">Phone</h3>
                    <p className="text-muted-foreground font-sans">(Available upon request)</p>
                </div>
            </div>
