    ...
    return (
        <>
            ...
            <SectionContainer id="about" bgColorClass="bg-section-about" fullWidthBg animated>
                <SectionHeader title="About Priyanshu" subtitle="Journey & Philosophy" alignment="left" />
                <div className="grid lg:grid-cols-3 gap-12 items-start">
                    <div className="lg:col-span-1 flex flex-col items-center">
                        ...
                        <p className="text-muted-foreground text-center mb-4 font-sans">Physics. Software. Music.</p>
                        <Button
                            variant="outline"
                            size="lg"
                    ...
                    <div className="lg:col-span-2 prose prose-lg dark:prose-invert max-w-none prose-headings:font-headline prose-p:font-sans prose-li:font-sans prose-p:text-muted-foreground prose-headings:text-foreground">
                        ...
                        <h3 className="font-headline text-2xl mt-8 mb-4">Beyond the code</h3>
                        <p>
            ...
            <SectionContainer id="skills" bgColorClass="bg-section-skills" fullWidthBg animated>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {skillCategories.map((category, index) => (
                        <SkillCategory key={category.name + index} category={category} animationDelay={index * 10} />
                    ))}
                </div>
            </SectionContainer>
            ...
            <SectionContainer id="experience" bgColorClass="bg-section-experience" fullWidthBg animated={false}>
                <SectionHeader title="Experience" subtitle="Professional Journey" alignment="left" />
                    ...
                    {educationData.map((edu, index) => (
                        ...
                        >
                            <div className="flex items-start sm:items-center mb-1">
                                ...
                                <h3 className="text-2xl lg:text-3xl font-headline text-foreground">{edu.degree}</h3>
                            </div>
                            <div className="pl-10">
                    ...
                    {honorsAwardsData.map((honor, index) => (
                        ...
                        >
                            <div className="flex items-center mb-1">
                                ...
                                <h3 className="text-xl lg:text-2xl font-headline text-foreground">{honor.title}</h3>
                            </div>
