...
const designationOptions = ["Potential Employer", "Mentee", "Friend", "Just Curious", "Other"] as const;
            ...
            <CardContent>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div>
                        ...
                        />
                        {errors.name && (
                            <p id="name-error" className="text-sm text-destructive mt-1 font-sans">
                                {errors.name.message}
                            </p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.email && (
                            <p id="email-error" className="text-sm text-destructive mt-1 font-sans">
                    ...
                    <div>
                        <Label htmlFor="designation" className="font-semibold font-sans">
                            I am a...
                        </Label>
                        <Controller
                            name="designation"
                        ...
                        />
                        {errors.designation && (
                            <p id="designation-error" className="text-sm text-destructive mt-1 font-sans">
                    ...
                    <div>
                        ...
                        />
                        {errors.message && (
                            <p id="message-error" className="text-sm text-destructive mt-1 font-sans">
