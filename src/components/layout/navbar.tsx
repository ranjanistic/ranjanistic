...
export function Navbar() {
    ...
    const NavLinkItem: React.FC<{ href: string; label: string; onClick?: () => void; isBrand?: boolean }> = ({
        href,
        label,
        onClick,
        isBrand = false,
                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="md:hidden">
                        <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                            ...
                            <SheetContent
                                side="right"
                                className="w-full max-w-xs bg-background p-6 border-l border-border/50"
                            >
                                <div className="flex flex-col space-y-1">
                                    ...
                                    {navLinksData.map(
                                        (
                                            link, // Use full navLinksData for mobile sheet
                                        ) => (
