...
export const heroData: HeroData = {
    ...
    tagline: "[System architect] [DevOps engineer] [Software developer] [UI-UX designer]",
    summary:
...
export const workExperienceData: WorkExperienceEntry[] = [
    ...
    },
    {
        ...
        imageUrls: [payr1.src, payr2.src, payr3.src, payr4.src, payr5.src, payr6.src],
    ...
    },
    {
        ...
        imageUrls: [testlify1.src, testlify3.src, testlify2.src],
    ...
    },
    {
        ...
        imageUrls: [clan1.src, clan3.src, clan2.src],
    ...
    },
    {
        ...
        imageUrls: [knotters1.src, knotters2.src, knotters3.src, knotters4.src],
    ...
    },
    {
        ...
        imageUrls: [soco1.src, soco2.src, soco3.src],
    ...
    },
    {
        ...
        imageUrls: [pm1.src, pm2.src, pm3.src],
        imageHints: ["virtual lab interface", "blockly ide screenshot", "javascript game preview"],
    },
    {
        role: "Web Developer",
        company: "Edu2Live",
...
const genericStoryline = (
    ...
    {
        type: "list",
        items: ["Core Feature 1 implementation", "Core Feature 2 development", "Key Technology stack integration"],
    },
...
export const projects: Project[] = [
    {
        ...
        storyline: genericStoryline("Stellar Evolution Modelling", "research project", mesa2.src),
    },
    {
        id: "knotters-portal",
    ...
    },
    {
        ...
        liveLink: undefined,
        repoLink: "https://gist.github.com/ranjanistic/dd39bdae19b306649f9b482a1be73284",
    ...
    },
    {
        ...
        liveLink: "https://github.com/ranjanistic/skivvy/releases/tag/v0.2.1-unborn-stage2",
